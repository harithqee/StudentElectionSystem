...
<body>
    ...
    <header>
        <h1>🗳️ Welcome to the Voting System</h1>
    </header>
    ...
    <main>
        ...
        <%-- JSP success message from URL parameter --%>
    ...
    <script>
        // Optional: Auto-select role from URL parameter if exists
        ...
        // Optional: Auto-fill username from URL parameter if exists
